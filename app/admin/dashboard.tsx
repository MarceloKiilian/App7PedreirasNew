...
import { Calendar, ShieldCheck, Users, LogOut, ChevronRight, ArrowLeft } from 'lucide-react-native';
...
export default function AdminDashboard() {
  ...
  const AdminMenuButton = ({ icon: Icon, label, route, color }: { icon: any, label: string, route: string, color: string }) => (
    <TouchableOpacity 
  ...
  return (
    <View style={styles.container}>
      ...
      <ScrollView contentContainerStyle={styles.content}>
        <Text style={styles.welcomeText}>Bem-vindo(a)! Escolha uma opção para gerenciar as informações do terreiro.</Text>
        ...
        <View style={styles.infoCard}>
          ...
          <Text style={styles.infoText}>
            Lembre-se de sair da área administrativa após terminar as alterações para manter os dados seguros.
          </Text>
        </View>
